...
# | Group   |   Count |   Min Length |   Max Length |    Mean |   Median |     Std | Mean ± Std        |
# |---------|---------|--------------|--------------|---------|----------|---------|-------------------|
# | high    |   83334 |           44 |         8082 | 1415.05 |      624 | 1787.46 | 1415.05 ± 1787.46 |
# | medium  |   82959 |           31 |         8079 |  622.55 |      284 | 1000.35 | 622.55 ± 1000.35  |
# | low     |   56075 |            6 |         6428 |  220.83 |      110 |  336.94 | 220.83 ± 336.94   |
...
DEFAULT_RAW_ROOT = BASE_DIR / "new_dataset" / "2_fbd"
DEFAULT_OUTPUT_ROOT = BASE_DIR / "new_dataset" / "3_fbt"
...
def process_modes(
    ...
    for mode in modes:
        input_filename = f"{dataset}_train_{mode}_raw_fbl_dedup.jsonl"
